...
using namespace std;
/**
*Overview :this is a client a pplication that send and receive messages but the application send and receive
* the messages in a sequential way which is not an efficient way that's why athreaded client application was proposed
* that can send and receive concurrently
**/
void main()
{
